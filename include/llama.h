...
extern "C" {
    ...
    struct llama_model_kv_buft_override {
        const char * pattern;
        ggml_backend_buffer_type_t buft;
    };
    ...
    struct llama_context_params {
        ...
        // NULL-terminated list of buffer types to use for kv layers that match a pattern
        const struct llama_model_kv_buft_override * kv_buft_overrides;
